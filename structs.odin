...
IO :: struct {
	...
	set_platform_ime_data_fn:                proc "c" (viewport: ^Viewport, data: rawptr),
	__unused1: rawptr,
	...
	// everything from here below is
	key_map:                                 [22]i32, // TODO size
	keys_down:                               [512]bool, // TODO size
	nav_inputs:                              [21]f32, // TODO size
	ctx:                                     ^Context,
	mouse_pos:                               Vec2,
	mouse_down:                              [5]bool,
	mouse_wheel:                             f32,
