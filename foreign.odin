...
foreign cimgui {
	...
	ImDrawList_AddText_Vec2                :: proc(self: ^Draw_List, pos: [2]f32, col: u32, text_begin: cstring, text_end: cstring) ---;
	ImDrawList_AddText_FontPtr             :: proc(self: ^Draw_List, font: ^ImFont, font_size: f32, pos: [2]f32, col: u32, text_begin: cstring, text_end: cstring, wrap_width: f32, cpu_fine_clip_rect: ^[4]f32) ---;
	...
	ImDrawList_GetClipRectMax              :: proc(pOut: ^[2]f32, self: ^Draw_List) ---;
	ImDrawList_GetClipRectMin              :: proc(pOut: ^[2]f32, self: ^Draw_List) ---;
	...
	ImDrawList__PathArcToFastEx            :: proc(self: ^Draw_List, center: [2]f32, radius: f32, a_min_sample: i32, a_max_sample: i32, a_step: i32) ---;
	ImDrawList__PathArcToN                 :: proc(self: ^Draw_List, center: [2]f32, radius: f32, a_min: f32, a_max: f32, num_segments: i32) ---;
	...
	ImFontAtlas_AddCustomRectFontGlyph                :: proc(self: ^Font_Atlas, font: ^ImFont, id: Wchar, width: i32, height: i32, advance_x: f32, offset: [2]f32) -> i32 ---;
	...
	ImFontGlyphRangesBuilder_BuildRanges :: proc(self: ^Font_Glyph_Ranges_Builder, out_ranges: ^Vector(Wchar)) ---;
	...
	ImFont_CalcTextSizeA         :: proc(pOut: ^[2]f32, self: ^ImFont, size: f32, max_width: f32, wrap_width: f32, text_begin: cstring, text_end: cstring, remaining: ^cstring) ---;
	...
	ImFont_RenderChar            :: proc(self: ^ImFont, draw_list: ^Draw_List, size: f32, pos: [2]f32, col: u32, c: Wchar) ---;
	ImFont_RenderText            :: proc(self: ^ImFont, draw_list: ^Draw_List, size: f32, pos: [2]f32, col: u32, clip_rect: [4]f32, text_begin: cstring, text_end: cstring, wrap_width: f32, cpu_fine_clip: bool) ---;
	...
	ImGuiViewport_GetCenter     :: proc(pOut: ^[2]f32, self: ^Viewport) ---;
	ImGuiViewport_GetWorkCenter :: proc(pOut: ^[2]f32, self: ^Viewport) ---;
	...
	igBeginChild_ID                    :: proc(id: ImID, size: [2]f32, border: bool, flags: Window_Flags) -> bool ---;
	igBeginChildFrame                  :: proc(id: ImID, size: [2]f32, flags: Window_Flags) -> bool ---;
	...
	igCalcTextSize                     :: proc(pOut: ^[2]f32, text: cstring, text_end: cstring, hide_text_after_double_hash: bool, wrap_width: f32) ---;
	...
	igColorConvertU32ToFloat4          :: proc(pOut: ^[4]f32, in_: u32) ---;
	...
	igGetContentRegionAvail            :: proc(pOut: ^[2]f32) ---;
	igGetContentRegionMax              :: proc(pOut: ^[2]f32) ---;
	igGetCurrentContext                :: proc() -> ^Context ---;
	igGetCursorPos                     :: proc(pOut: ^[2]f32) ---;
	igGetCursorPosX                    :: proc() -> f32 ---;
	igGetCursorPosY                    :: proc() -> f32 ---;
	igGetCursorScreenPos               :: proc(pOut: ^[2]f32) ---;
	igGetCursorStartPos                :: proc(pOut: ^[2]f32) ---;
	...
	igGetFontTexUvWhitePixel           :: proc(pOut: ^[2]f32) ---;
	...
	igGetIO                            :: proc() -> ^IO ---;
	igGetItemRectMax                   :: proc(pOut: ^[2]f32) ---;
	igGetItemRectMin                   :: proc(pOut: ^[2]f32) ---;
	igGetItemRectSize                  :: proc(pOut: ^[2]f32) ---;
	...
	igGetMouseDragDelta                :: proc(pOut: ^[2]f32, button: Mouse_Button, lock_threshold: f32) ---;
	igGetMousePos                      :: proc(pOut: ^[2]f32) ---;
	igGetMousePosOnOpeningCurrentPopup :: proc(pOut: ^[2]f32) ---;
	...
	igGetWindowContentRegionMax        :: proc(pOut: ^[2]f32) ---;
	igGetWindowContentRegionMin        :: proc(pOut: ^[2]f32) ---;
	igGetWindowContentRegionWidth      :: proc() -> f32 ---;
	igGetWindowDrawList                :: proc() -> ^Draw_List ---;
	igGetWindowHeight                  :: proc() -> f32 ---;
	igGetWindowPos                     :: proc(pOut: ^[2]f32) ---;
	igGetWindowSize                    :: proc(pOut: ^[2]f32) ---;
	...
	igImageButton                      :: proc(user_texture_id: Texture_ID, size: [2]f32, uv0: [2]f32, uv1: [2]f32, frame_padding: i32, bg_col: [4]f32, tint_col: [4]f32) -> bool ---;
	...
	igInputTextMultiline               :: proc(label: cstring, buf: cstring, buf_size: uint, size: [2]f32, flags: Input_Text_Flags, callback: Input_Text_Callback, user_data: rawptr) -> bool ---;
	...
	igPlotHistogram_FnFloatPtr         :: proc(label: cstring, values_getter: Value_Getter_Proc, data: rawptr, values_count: i32, values_offset: i32, overlay_text: cstring, scale_min: f32, scale_max: f32, graph_size: [2]f32) ---
	...
	igPlotLines_FnFloatPtr             :: proc(label: cstring, values_getter: Value_Getter_Proc, data: rawptr, values_count: i32, values_offset: i32, overlay_text: cstring, scale_min: f32, scale_max: f32, graph_size: [2]f32) ---
	...
	igTextColored                      :: proc(col: [4]f32, fmt_: cstring, #c_vararg args: ..any) ---;
